...
public class GenerateNewLicenseRequest {
	...
	// Enforce exactly 10 numeric digits using a single pattern for clearer validation
	@Pattern(regexp = "^[0-9]{10}$", message = "Mobile number must be exactly 10 digits (numbers only)")
